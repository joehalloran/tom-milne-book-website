        ...
        <div class="container">
	        ...
	        <div id="navbar" class="collapse navbar-collapse">
                ...
                <li><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php esc_html_e('About', 'bookclub') ?><span class="caret"></span></a>
                    ...
                    <li><a href=<?php echo home_url( '/' )."get-copies-of-the-books" ?> ><?php esc_html_e('Get copies of the books', 'bookclub') ?></a></li>
    		            <li><a href=<?php echo home_url( '/' )."audio-books" ?> ><?php esc_html_e('Audio books', 'bookclub') ?></a></li>
                    <li><a href=<?php echo home_url( '/' )."other-favourite-books" ?> ><?php esc_html_e('Other favourite books', 'bookclub') ?></a></li>
                  </ul>
                </li>
