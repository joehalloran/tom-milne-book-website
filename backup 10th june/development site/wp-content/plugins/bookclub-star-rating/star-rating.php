<?php
/*
Plugin Name: Book Club Star Rating
Plugin URI: 
Description: Star Rating for Rosendale reads based on Paratheme star rating
Version: 1.0
Author: Joe Halloran - based on paratheme
Author URI: 
...
require_once( plugin_dir_path( __FILE__ ) . 'themes/user/index.php');
require_once( plugin_dir_path( __FILE__ ) . 'themes/static/index.php');
...
function star_rating_init_scripts()
	{
		...
		wp_enqueue_style('star-rating-style-flat', star_rating_plugin_url.'themes/user/style.css');
		wp_enqueue_style('star-rating-style-flat', star_rating_plugin_url.'themes/static/style.css');
