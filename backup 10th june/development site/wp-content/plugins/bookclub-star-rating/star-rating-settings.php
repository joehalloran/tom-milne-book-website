    ...
    <div class="para-settings up-paratheme-settings">
		...
		<ul class="box">
            <li style="display: block;" class="box1 tab-box active">
                ...
                <div class="option-box">
                    <p class="option-title">Short-code User's last rating for php file</p>
                    <p class="option-info">Short-code inside loop by dynamic post id you can use anywhere inside loop or single.php</p>
                    <pre>&#60;?php<br />echo do_shortcode( '&#91;user_star_rating themes="user" id="'.get_the_ID().'" user_ID="'.get_current_user_id().'"&#93;' ); <br />?&#62;</pre>
